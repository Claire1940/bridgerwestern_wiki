...
const WIKI_LINKS = [
	...
	{ name: 'reawakened.wiki', url: 'https://www.reawakened.wiki' },
			...
			<div className="container mx-auto px-4 py-4">
				<div className="flex items-center justify-between">
					...
					>
						...
						<span className="font-bold text-lg hidden sm:inline">Bridger: WESTERN</span>
						<span className="font-bold text-lg sm:hidden">BW</span>
					</Link>
